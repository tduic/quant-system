  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        <Card title="Current Drawdown" value={`${data.current_drawdown_pct.toFixed(2)}%`} positive={data.current_drawdown_pct === 0} />
      ...
      {equityData.length > 1 && (
        <div>
          <h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wide mb-3">Equity Curve</h3>
      ...
      {drawdownData.length > 1 && (
        <div>
          <h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wide mb-3">Drawdown Curve</h3>
          <div className="bg-gray-900 rounded-lg p-4 border border-gray-800">
            <ResponsiveContainer width="100%" height={250}>
              <AreaChart data={drawdownData}>
                ...
                />
                <Area type="monotone" dataKey="drawdown" stroke="#F87171" fill="#F87171" fillOpacity={0.15} />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
